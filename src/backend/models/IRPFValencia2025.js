...
export class IRPFValencia2025 {
  ...
  static getTipoMarginalAutonomico(base) {
    for (const tramo of this.TRAMOS_AUTONOMICOS_VALENCIA) { if (tramo.infinito || base <= tramo.hasta) return tramo.tipo; }
    return this.TRAMOS_AUTONOMICOS_VALENCIA.at(-1).tipo;
  }
